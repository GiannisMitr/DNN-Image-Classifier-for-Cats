## Functions for implementing an L layer deep neural network, with L-1 [LINEAR -> RELU] layers and an output layer of LINEAR -> SIGMOID
## Regularization, momentum or mini-batch techniques are NOT used.
import numpy as np
...
#  initialize_parameters_deep([5,4,3]) will initiallize a 2 hidden layer network with 5d inputs, 4 nodes middle layer and 3 nodes exit layer.
